...
```text
                                                                   user
void scan                                                      0.000979
20k facts: export: 2977KB                                      0.863422
20k facts: import: 2977KB                                      0.965197
50k facts: read                                                0.000187
50k facts: read in txn                                         0.001406
50k facts: insert                                              0.000084
50k facts: insert in txn                                       0.000240
50k facts: modify                                              1.353833
50k facts: modify in txn                                       2.320316
12k facts: large query: match 3k                              13.295269
12k facts: large query: match 3k in txn                       19.104545
12k facts: large query: match zero                            14.250995
12k facts: large query: match zero in txn                     20.065734
```

The results were calculated in [this GHA job][benchmark-gha]
on 2026-09-07 at 06:36,
on Linux with 4 CPUs.
<!-- benchmark_end -->

[benchmark-gha]: https://github.com/yegor256/factbase/actions/runs/34091399425
